# Auto Renew flaminghosting

自动续期 flaminghosting 免费游戏机的脚本，使用 GitHub Actions 每96小时自动运行一次。
...
1. 打开 [flaminghosting](https://panel.flaminghosting.com/auth/login)，使用邮箱密码注册账号
2. 打开浏览器开发者工具（F12）
3. 切换到 Appcation 选项
4. 刷新页面
